...
if __name__ == '__main__':
    ...
    # img = uint2single(img)
    # img_bicubic = imresize_np(img, 1/4) * 255
    # from test_resize import imresize as test_imresize
    # img_bicubic_t = test_imresize(img, 1/4) * 255
    # print(np.abs(img_bicubic - img_bicubic_t).sum())
    # imsave(img_bicubic, './x4.png')
